...
class FeMaSRTestModel(BaseModel):
    ...
    def test(self):
        ...
        # else:
        # self.output, self.l_codebook, self.l_semantic = net_g.test_tile(lq_input, rtn_all=True)
        self.net_g.train()
    ...
    def _log_validation_metric_values(self, current_iter, dataset_name, tb_logger):
        ...
        for metric, value in self.metric_results.items():
            ...
            if hasattr(self, 'best_metric_results'):
                if metric in self.best_metric_results[dataset_name]:
